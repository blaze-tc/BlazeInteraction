...
if ($embeddedVersion -ne '1.2.5') { throw "Embedded RadarBridge version marker must be 1.2.5; found '$embeddedVersion'." }
...
try {
    ...
    Write-Host 'IPC v2 Hello/HelloAck passed with Bridge version 1.2.5.'
